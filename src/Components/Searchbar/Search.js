                ...
                <div className="row search-bar">
                    <div class="input-group mb-3">
                        ...
                        style={{cursor: 'pointer', transition: "all ease .3s", marginRight:"5px"}}>
                            ...
                            class={`input-group-text h-100 w-100 ${value.length > 0 ? 'border border-danger' : null}`}>
                                {value.length > 0 ?
                        ...
                        <input onChange={handleInput} value={value} type="text" class="form-control" placeholder="Search any product" aria-describedby="basic-addon1" />
                    </div>
                </div>
            </div>
        </>
